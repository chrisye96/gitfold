 ...
 */
export function buildAuthUrl(env, state, redirectUri) {
 ...
 */
export async function exchangeCode(code, env, redirectUri) {
 ...
 */
export async function findOrCreateUser(db, githubUser) {
    const now = Date.now();
 ...
 */
export async function storeOAuthToken(db, userId, accessToken, encryptionKey) {
    const now = Date.now();
 ...
 */
export async function getUserOAuthToken(db, userId, encryptionKey) {
 ...
 */
export async function createOAuthState(kv) {
 ...
 */
export async function validateOAuthState(kv, state) {
