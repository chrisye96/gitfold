...
function headerHTML(page) {
  ...
  <a href="/" class="site-logo" aria-label="GitSnip home">
    <svg class="logo-icon" viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
  ...
  <nav class="site-nav" aria-label="Main navigation">
    ...
    <a href="/docs#api" data-i18n="nav.api">API</a>
    <a href="https://github.com/gitsnip/gitsnip"
       target="_blank" rel="noopener noreferrer"
       data-i18n="nav.github"
       aria-label="GitSnip on GitHub (opens in new tab)">GitHub</a>
    <button id="theme-toggle" class="btn-theme-toggle" type="button" aria-label="Switch to dark mode">
      <svg id="icon-moon" viewBox="0 0 512 512" width="18" height="18" fill="none" stroke="currentColor" stroke-width="32" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
